...
const FALLBACK_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    author: "Karen Hecker",
    date: "Noviembre 2025",
    text: "La ubicación es excelente, el depto muy completo, amplio, cómodo, muy prolijo, y la amabilidad de su gente. Una hermosura todo. Muy serviciales, la secrety y los dueños, un amor. Nos sentimos muy cómodos.",
    tripTypes: ["Vacaciones", "Familiar"],
    categoryScores: { habitaciones: 4, servicio: 4, ubicacion: 5 },
    highlights: ["Tranquilo", "Buen precio"],
    ownerResponse: {
      text: "Mucho nos alegra querida Karen que se hayan sentido cómodos y a gusto con nosotros. Los esperamos pronto nuevamente aquí. Mucha gracias!",
      date: "Noviembre 2025",
    },
  },
  {
  ...
  },
  {
    ...
    author: "Jaqui",
    date: "Diciembre 2025",
    text: "Hermoso lugar. Muy confortable. Cerca del Shopping. Excelente ubicación y atención. Cuenta con estacionamiento privado. Todo excelente.",
    categoryScores: { habitaciones: 5, servicio: 5, ubicacion: 5 },
    ownerResponse: {
      text: "Jaqui mucho nos complace saber que se han sentido cómodos y a gusto en nuestro apart. Gracias y los esperamos pronto!",
      date: "Diciembre 2025",
    },
  },
];
